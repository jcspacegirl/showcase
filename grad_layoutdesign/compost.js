...
function drop(event) {
    ...
    if (element && element.draggable) {
        ...
        if (itemCount === totalItems) {
            setTimeout(function() {
                alert("Well done for becoming a compost master! You are successfully contributing to a greener earth! Now lets head over to play a memory match game!");
            }, 500); // Delay the alert slightly for better UX
        }
    }
}
